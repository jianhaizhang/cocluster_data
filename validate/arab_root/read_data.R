...
df.match <- df_match()
# sc.arab.rt9
sc.all9 <- scell_dat('/GSM4625994_sc_9_at_COPILOT.rds', df.match=df.match) # Read data.                       
as.matrix(sc.all9[1:3, 1:5])
# sc.arab.rt51
sc.all51 <- scell_dat('/GSM4626006_sc_51_COPILOT.rds', df.match=df.match) # Read data.                        
as.matrix(sc.all51[1:3, 1:5])
